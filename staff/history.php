        ...
        <aside class="sidebar">
            ...
            <nav>
                <div class="nav-section">
                    ...
                    <a href="pending.php"><i class="fas fa-hourglass-half"></i> Pending Approvals</a>
                </div>
                <div class="nav-section">
            ...
            <section class="page">
                ...
                <div class="welcome-section">
                    <div class="welcome-header">
                        <div class="welcome-content">
                            ...
                            <p>Complete record of all transactions and their current status</p>
                        </div>
                ...
                <div class="quick-actions">
                    ...
                    <div class="quick-card">
                        ...
                        <div class="quick-copy">
                            ...
                            <p>Review and approve customer transactions</p>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <span class="card-title"><i class="fas fa-history"></i> All Transactions</span>
