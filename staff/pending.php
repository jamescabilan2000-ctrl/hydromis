...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'], $_POST['transaction_id'])) {
    ...
    if ($action === 'approve') {
        $conn->query("UPDATE transactions SET status = 'approved', delivery_status = 'pending', rider_id = NULL, approved_by = '$staff_id' WHERE transaction_id = '$transaction_id'");
        $_SESSION['staff_flash'] = "Transaction {$transaction_id} approved successfully.";
    } elseif ($action === 'deny') {
        $conn->query("UPDATE transactions SET status = 'denied', rider_id = NULL, approved_by = '$staff_id' WHERE transaction_id = '$transaction_id'");
        ...
        <aside class="sidebar">
            ...
            <nav>
                <div class="nav-section">
                    ...
                    <a href="pending.php" class="active"><i class="fas fa-hourglass-half"></i> Pending Approvals <span class="badge">5</span></a>
                </div>
                <div class="nav-section">
        ...
        <main class="main">
            <div class="topbar">
                ...
                <div class="topbar-actions">
                    <span>Staff: <?php echo htmlspecialchars($_SESSION['full_name']); ?></span>
                ...
                <div class="welcome-section">
                    <div class="welcome-header">
                        ...
                        <div class="welcome-actions">
                            <a href="dashboard.php" class="primary-btn"><i class="fas fa-home"></i> Dashboard</a>
                        </div>
                    </div>
                </div>
