...
<aside class="staff-sidebar">
    ...
    <nav class="staff-sidebar-nav">
        ...
        <div class="staff-delivery-menu" id="staffDeliveryMenu">
            <a class="<?php echo $staff_active === 'deliveries' ? 'active' : ''; ?>" href="dashboard.php?view=deliveries"><i class="fas fa-truck-fast"></i>Delivery Operations<span class="staff-nav-redmark" style="<?= $delivery_nav + $pickup_nav > 0 ? '' : 'display:none' ?>"><?= $delivery_nav + $pickup_nav ?></span></a>
            <button type="button" class="staff-delivery-toggle" id="staffDeliveryToggle" aria-expanded="false" aria-label="Toggle Delivery Operations menu"><i class="fas fa-chevron-down"></i><span class="staff-pickup-dot" style="<?= $pickup_nav > 0 ? '' : 'display:none' ?>" aria-label="Pickup orders waiting"></span></button>
            <div class="staff-delivery-submenu">
                <a href="dashboard.php?view=deliveries&amp;section=pickups"><i class="fas fa-store"></i>Pickup Orders<span class="staff-nav-redmark" style="<?= $pickup_nav > 0 ? '' : 'display:none' ?>"><?= $pickup_nav ?></span></a>
            </div>
        </div>
        ...
        <a class="<?php echo $staff_active === 'feedbacks' ? 'active' : ''; ?>" href="dashboard.php?view=deliveries&amp;section=feedbacks"><i class="fas fa-comments"></i>Customer Feedback</a>
