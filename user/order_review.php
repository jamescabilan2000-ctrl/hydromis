...
<head>
    ...
    <style>
        ...
        * {
        ...
        .review-grid{display:grid;grid-template-columns:minmax(0,1.15fr) minmax(320px,.85fr);border-top:1px solid #e3edf2}.review-config{padding:25px 27px 28px;border-right:1px solid #e3edf2}.review-config .row-box{padding:0;border:0}.review-config .row-box+.row-box{margin-top:23px;padding-top:23px;border-top:1px solid #e6eef2}.item-row{padding:18px;border:1px solid #dceaf0;border-radius:20px;background:linear-gradient(145deg,#fbfeff,#edf8fb);box-shadow:0 12px 28px rgba(31,104,134,.08)}.item-thumb{width:112px;height:112px;padding:4px;border:0;border-radius:18px;background:radial-gradient(circle at 50% 42%,#fff,rgba(201,235,244,.64) 70%,transparent);filter:drop-shadow(0 14px 16px rgba(15,94,138,.2));mix-blend-mode:normal;animation:gallonFloat 4.8s ease-in-out infinite}.item-title{font-size:19px}.qty-box{background:rgba(255,255,255,.82);box-shadow:0 9px 20px rgba(24,91,122,.1)}
    ...
    <div class="confirm-overlay" id="confirmOverlay" aria-hidden="true">
        <div class="confirm-card" role="dialog" aria-modal="true" aria-labelledby="confirmTitle">
            ...
            <div class="confirm-actions">
                ...
                <button type="button" class="confirm-proceed" id="confirmProceed"></i> Proceed to checkout</button>
            </div>
        </div>
    </div>
