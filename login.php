...
$conn->query("INSERT INTO rider_users (rider_id, username, password, full_name, contact_number, status)
	SELECT 'RID-001', 'rider1', '{$defaultRiderHash}', 'Default Rider', '09990000001', 'active'
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['login_submit'])) {
	...
	if ($role === 'rider') {
		$sql = "SELECT rider_id, username, password, full_name FROM rider_users WHERE username = '$username' AND status = 'active' LIMIT 1";
